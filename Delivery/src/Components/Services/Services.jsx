...
const Services = () => {
    ...
    return (
        <div className={`${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'} p-4 md:p-8 roboto-normal`}>
            <button className={`p-3 md:p-4 border-2 roboto-bold text-sm md:text-base ${isDarkMode ? 'bg-gray-800 border-blue-900' : 'bg-white border-black'} rounded-3xl`}>Customer Centric Approach</button>
